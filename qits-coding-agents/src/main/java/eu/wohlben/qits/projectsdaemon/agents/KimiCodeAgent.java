 ...
 * acp}, driven by an in-JVM ACP client ({@code eu.wohlben.qits.projectsdaemon.agents.acp}).
 */
public class KimiCodeAgent extends CodingAgent {
   ...
   * eu.wohlben.qits.projectsdaemon.agents.acp}) drives these pipes, normalizing {@code
