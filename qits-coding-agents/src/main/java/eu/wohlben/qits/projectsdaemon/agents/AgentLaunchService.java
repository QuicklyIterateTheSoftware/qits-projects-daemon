...
import eu.wohlben.qits.projectsdaemon.agents.acp.AcpChatProtocol;
...
import eu.wohlben.qits.projectsdaemon.commands.StreamJsonChatProtocol;
 ...
 *
 * <ul>
 *   <li>the project and repository ids leave every signature — they are ambient on {@link
 *       ProjectContext};
    ...
    return switch (scope) {
      ...
      case REPOSITORY ->
          List.of(
              new ScopedMcp(
                  "repository",
                  base + "&repositoryId=" + requireId(project.repoName(), "repository id"),
