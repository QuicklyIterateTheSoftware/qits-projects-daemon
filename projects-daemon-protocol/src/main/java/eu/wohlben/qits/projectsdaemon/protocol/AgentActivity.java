...
/**
 * A coding agent's lifecycle state, pushed <em>unsolicited</em> from {@code projects-daemon} to
 ...
 * Unlike {@link ProjectInfo} (the reply to a {@link Describe}), this frame is not correlated to any
 * request — the backend caches the {@code state} per {@code commandId} and drives the live
 * "cooking / idle / waiting" chip and the {@code SessionStart} lineage write from it.
 *
